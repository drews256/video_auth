...
const config = {
  siteTitle: "Video Auth", // Site title.
  siteTitleShort: "Quartz Content Authentication", // Short site title for homescreen (PWA). Preferably should be under 12 characters to prevent truncation.
  siteTitleAlt: "Quartz Video, File, Content Auhentication", // Alternative site title for SEO.
  siteLogo: "/logos/Fingerprint.png", // Logo used for SEO and manifest.
